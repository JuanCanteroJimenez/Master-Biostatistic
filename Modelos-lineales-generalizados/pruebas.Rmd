...
Si atendemos ahora a los coeficientes, estos son:
...
tabla5 <- data.frame(Modelo = c("aj1.poi.log.horas", "aj1.poi.log.consultas","aj1.poi.log.original"),
                     ...
                     Shapiro.test = c(
                                               round(shapiro.test(residuals(aj1.poi.log.horas, type = "deviance"))$p.value,4),
                                               
                                               round(shapiro.test(residuals(aj1.poi.log.consultas, type = "deviance"))$p.value,4),
