...
### Es necesario destacar que la función fviz_cluster realiza un análisis de componentes principales para representar valores multidimensionales en dos dimensiones. En este caso, las dos componentes principales recogen el 25.7 % y 22.8 % de la variavilidad total de los datos. 
l_cluster <- list()
